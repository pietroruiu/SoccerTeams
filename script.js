document.addEventListener('DOMContentLoaded', () => {
        ...
        fetch('players_example.xlsx')  
            ...
            .then(data => {
                ...
                players = playersArray.map(player => ({
                    ...
                    selected: false // Inizialmente nessun giocatore è selezionato
                }));
    ...
    function displayPlayers() {
        ...
        players.forEach((player) => {
            ...
            li.textContent = `Name: ${player.name}, Presence: ${player.presence ? 'Present' : 'Absent'}, Defense: ${player.defense}, Attack: ${player.attack}, Midfield: ${player.midfield}, Goalie: ${player.goalie}, Speed: ${player.speed}, Shooting: ${player.shooting}`;
